...
The `local/personal-optimizations` branch keeps upstream zashboard as the base and carries a small local optimization set. The proxy-page feature direction is inspired by [AnGe-ClashBoard](https://github.com/liandu2024/AnGe-ClashBoard), with local interaction and maintenance-focused adjustments:
