const en = {
  ...
  strategyPenetration: 'Strategy penetration',
  collapsePenetration: 'Collapse penetration',
  stepwisePenetration: 'Stepwise',
  fullExpansion: 'Full expansion',
  noPenetrableProxyGroup: 'No penetrable proxy group',
  backToParent: 'Back',
  backToRoot: 'Root',
  currentProxyGroup: 'Current group',
  childProxyGroups: 'Child groups',
