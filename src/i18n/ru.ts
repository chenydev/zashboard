...
const ru: LANG_MESSAGE = {
  ...
  strategyPenetration: 'Проникновение стратегий',
  collapsePenetration: 'Свернуть проникновение',
  stepwisePenetration: 'Пошагово',
  fullExpansion: 'Полное раскрытие',
  noPenetrableProxyGroup: 'Нет группы для проникновения',
  backToParent: 'Назад',
  backToRoot: 'Корень',
  currentProxyGroup: 'Текущая группа',
  childProxyGroups: 'Дочерние группы',
  proxyNodes: 'Узлы прокси',
